 ...
 * 
 * <tr>
 * <td><code>List&lt;URL&gt;</code></td>
 * <td><code>localDomainSpecs</code></td>
 * <td><code>localDmlSpec</code></td>
 * <td>The list of project-local DML specifications. For these DML specifications, the compiler will generate base classes (and
 * non-base classes if they do not exist). Default: empty list.</td>
 * <td rowspan="3">Must provide DML specifications either using <code>localDmlSpecs/externalDmlSpecs</code> or
 * <code>projectName</code></td>
 * </tr>
 * 
 * <tr>
 * <td><code>List&lt;URL&gt;</code></td>
 ...
 * <td>The list of project-external DML specifications. For these DML specifications, the compiler will generate base classes
 * only. Default: empty list.</td>
 * </tr>
 * 
 * <tr>
 * <td><code>String</code></td>
 ...
 * <td><code>pn</code></td>
 * <td>The name of the project. The compiler will search for a &lt;projectName&gt;/project.properties file with the local DML
 * files and other project dependencies to set the local/external specs.</td>
 * </tr>
 * 
 * <tr>
 * <td><code>Class&lt;? extends CodeGenerator&gt;</code></td>
...
public class CompilerArgs {
    ...
    public CompilerArgs(File destDirectory, File destDirectoryBase, String packageName, Boolean generateFinals,
        ...
        if (externalDomainSpecs != null) {
            this.externalDomainSpecs.addAll(externalDomainSpecs);
        }
        checkArguments();
    }

    /**
     * Create the CompilerArgs using the project name (requires a <code>&lt;projName&gt;</code>/project.properties file in the
     * classpath).
     */
    public CompilerArgs(File destDirectory, File destDirectoryBase, String packageName, Boolean generateFinals,
