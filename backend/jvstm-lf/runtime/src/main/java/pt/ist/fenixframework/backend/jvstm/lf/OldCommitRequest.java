...
public class OldCommitRequest implements DataSerializable {
    private static final long serialVersionUID = 1L;

    private static final Logger logger = LoggerFactory.getLogger(OldCommitRequest.class);
    ...
    public OldCommitRequest() {
        // required by Hazelcast's DataSerializable
    }

    public OldCommitRequest(int serverId, int txNumber, Map<jvstm.VBox, Object> boxesWritten) {
    ...
    public void writeData(DataOutput out) throws IOException {
        ...
        logger.debug("OldCommitRequest approximate size: {} bytes", commitSize);
    }
    ...
    public static class SpeculativeCommitRequest extends OldCommitRequest {
        private static final long serialVersionUID = 1L;
        ...
        // makes a speculative OldCommitRequest (doesn't yet know the transaction number). Advantage: can be performed outside the locked code :-)
