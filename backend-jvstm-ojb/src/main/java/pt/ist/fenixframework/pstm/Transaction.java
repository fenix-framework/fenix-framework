...
public abstract class Transaction extends jvstm.Transaction {
    ...
    public static void addRelationTuple(String relation, AbstractDomainObject obj1, String colNameOnObj1, AbstractDomainObject obj2,
	    String colNameOnObj2) {
	currentDBChanges().addRelationTuple(relation, obj1, colNameOnObj1, obj2, colNameOnObj2);
    }

    public static void removeRelationTuple(String relation, AbstractDomainObject obj1, String colNameOnObj1, AbstractDomainObject obj2,
	    String colNameOnObj2) {
