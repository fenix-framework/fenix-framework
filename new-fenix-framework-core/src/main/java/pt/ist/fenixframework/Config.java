...
public class Config {
     ...
     * DomainModel should be created by the DmlCompiler when parsing a DML
     * file.
     */
    protected Class<? extends DomainModel> domainModelClass = DomainModel.class;
    ...
    /**
     * This <strong>optional</strong> parameter indicates whether the framework
     * will load additional plugins on startup.
     */
