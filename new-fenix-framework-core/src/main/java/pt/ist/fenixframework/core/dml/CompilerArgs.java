...
public class CompilerArgs {
    ...
    Class<? extends CodeGenerator> generatorClass = ConcreteCodeGenerator.class;
	...
	this.generatorClass = generatorClass != null ? generatorClass : ConcreteCodeGenerator.class;
	...
	if (args[pos].equals("-d")) {
	    ...
	    generatorClass = (Class<? extends ConcreteCodeGenerator>) Class.forName(getNextArgument(args, pos));
	    return pos + 2;
