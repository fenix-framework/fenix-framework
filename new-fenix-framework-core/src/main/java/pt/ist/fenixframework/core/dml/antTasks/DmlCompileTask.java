package pt.ist.fenixframework.core.dml.antTasks;
...
import pt.ist.fenixframework.core.dml.ConcreteCodeGenerator;
import pt.ist.fenixframework.core.dml.CompilerArgs;
import pt.ist.fenixframework.core.dml.DmlCompiler;
import pt.ist.fenixframework.core.dml.DomainModel;

public class DmlCompileTask extends Task {

    private static final Class<DomainModel> defaultDomainModelClass = DomainModel.class;
    private static final Class<? extends CodeGenerator> defaultCodeGeneratorClass = ConcreteCodeGenerator.class;
