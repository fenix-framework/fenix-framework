...
import pt.ist.fenixframework.backend.ogm.util.TxMap;
...
public class OgmTransactionManager implements TransactionManager {
	...
	SessionFactoryImplementor sessionFactory = (SessionFactoryImplementor) ((HibernateEntityManagerFactory) emf)
		.getSessionFactory();
