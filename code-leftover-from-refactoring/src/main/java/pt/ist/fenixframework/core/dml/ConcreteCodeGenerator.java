package pt.ist.fenixframework.core.dml;
...
import pt.ist.fenixframework.core.CodeGenerator;
...
public class ConcreteCodeGenerator implements CodeGenerator {
    ...
    public ConcreteCodeGenerator(CompilerArgs compArgs, DomainModel domainModel) {
    ...
    protected void generateStaticRoleSlots(Role role, PrintWriter out) {
        ...
        String inverseRoleType = makeGenericType("pt.ist.fenixframework.core.dml.runtime.Role",
    ...
    protected void generateRoleClassGetter(Role role, Role otherRole, PrintWriter out) {
        ...
        print(out, "public ");
        print(out, makeGenericType((multOne ? getBoxBaseType() : "pt.ist.fenixframework.core.dml.runtime.RelationBaseSet"), getTypeFullName(role.getType())));
        print(out, " ");
    ...
    protected String getDirectRelationType() {
        return pt.ist.fenixframework.core.dml.runtime.DirectRelation.class.getName();
    }
    ...
    protected void generateStaticRelationSlots(Role role, PrintWriter out) {
        ...
        print(out, isDirectRelation ? directRelationType : "pt.ist.fenixframework.core.dml.runtime.Relation");
    ...
    protected String getRoleBaseType(Role role) {
        return ((role.getName() == null)
                ? "pt.ist.fenixframework.core.dml.runtime.RoleEmpty"
    ...
    protected String getRoleOneBaseType() {
        return "pt.ist.fenixframework.core.dml.runtime.RoleOne";
    }

    protected String getRoleManyBaseType() {
        return "pt.ist.fenixframework.core.dml.runtime.RoleMany";
    }
    ...
    protected String getRelationAwareBaseTypeFor(Role role) {
        ...
        return "pt.ist.fenixframework.core.dml.runtime.RelationAwareSet";
    }
    ...
    protected void generateRequiredConsistencyPredicate(DomainClass domClass, PrintWriter out) {
        ...
        for (Slot slot : domClass.getSlotsList()) {
            if (slot.hasOption(Slot.Option.REQUIRED)) {
                ...
                print(out, "pt.ist.fenixframework.core.dml.runtime.ConsistencyChecks.checkRequired(this, \"");
                print(out, slotName);
                print(out, "\", get");
