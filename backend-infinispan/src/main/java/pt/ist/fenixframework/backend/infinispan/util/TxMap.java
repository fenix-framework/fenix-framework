package pt.ist.fenixframework.backend.infinispan.util;
...
import pt.ist.fenixframework.backend.infinispan.InfinispanTransaction;
...
public class TxMap {
	...
	if (txLocal == null) {
	    txLocal = new InfinispanTransaction(transaction);
