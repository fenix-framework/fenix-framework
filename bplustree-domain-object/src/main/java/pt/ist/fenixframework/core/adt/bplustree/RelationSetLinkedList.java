...
public class RelationSetLinkedList<E1 extends AbstractDomainObject,E2 extends AbstractDomainObject> extends AbstractSet<E2> implements RelationBaseSet<E2> {
    private E1 listHolder;
    private Relation<E1,E2> relation;

    private LinkedList<E2> elements;

    public RelationSetLinkedList(E1 listHolder, Relation<E1,E2> relation, LinkedList<E2> elements) {
	...
	return elements.contains((E2)obj);
    }
	...
	private RelationSetLinkedList<?,X> list;
	private Iterator<X> iter;
	private boolean canRemove = false;
	private X previous = null;

	RelationSetIterator(RelationSetLinkedList<?,X> list) {
	    this.list = list;
