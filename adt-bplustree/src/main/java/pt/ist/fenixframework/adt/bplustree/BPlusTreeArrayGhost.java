 ...
 */
public class BPlusTreeArrayGhost<T extends Serializable> extends BPlusTreeArrayGhost_Base implements DomainBasedMap<T> {

    private static final Logger logger = LoggerFactory.getLogger(BPlusTreeArrayGhost.class);
    ...
    private void initRoot() {
        this.setRoot(new LeafNodeArrayGhost());
    }
    ...
    public T getIndex(int index) {
        return ((AbstractNodeArrayGhost<T>) this.getRoot()).getIndex(index);
    }
    ...
    public T removeIndex(int index) {
        ...
        AbstractNodeArrayGhost rootNode = this.getRoot();
        AbstractNodeArrayGhost resultNode = rootNode.removeIndex(index);
        if (rootNode != resultNode) {
            this.setRoot(resultNode);
        }
    ...
    public boolean myEquals(BPlusTreeArrayGhost other) {
